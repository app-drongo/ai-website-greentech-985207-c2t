...
const DEFAULT_HERO = {
  ...
  statsLabel1: 'CO2 Reduced',
  statsValue1: '2.4M tons',
        ...
        <div className="grid items-center gap-12 py-20 sm:py-24 lg:grid-cols-2 lg:gap-20 lg:py-32">
          <div className="flex flex-col justify-center">
            ...
            <h1 className="text-4xl font-bold tracking-tight sm:text-5xl lg:text-6xl">
              ...
              <span
                className="block bg-gradient-to-r from-green-600 to-emerald-500 bg-clip-text text-transparent"
            ...
            <div className="mt-8 flex flex-col gap-4 sm:flex-row">
              <Button
                size="lg"
                className="group px-7 text-base bg-green-600 hover:bg-green-700"
              ...
              <Button
                size="lg"
                variant="outline"
                className="text-base border-green-200 text-green-700 hover:bg-green-50"
          ...
          <div className="relative">
            ...
            <div className="absolute -left-6 -bottom-6 hidden w-36 rounded-xl border bg-background/90 p-3 shadow-xl sm:block">
              ...
              <p className="text-sm">
                <span className="font-semibold text-green-600" data-editable="statsValue2">
                  {config.statsValue2}
                </span>
              </p>
            </div>
